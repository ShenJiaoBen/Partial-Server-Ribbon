...
local WindUI = loadstring(request({Url = "https://github.com/Footagesus/WindUI/releases/latest/download/main.lua"}).Body)()
...
WindUI:AddTheme({
        ...
        WindUI:SetFont("rbxassetid://12187366846")
        ...
        local Window = WindUI:CreateWindow({
            ...
            Background = "rbxassetid://124561190267041",
            SideBarWidth = 150,
            HideSearchBar = true,
...
spawn(function()
    while task.wait() do
        pcall(function()
            ...
            GameTimeParagraph:SetDesc(Hour .. " 小时 " .. Minute .. " 分钟 " .. Second .. " 秒");
        end);
    end
end);
...
task.spawn(function()
    while wait(0.2) do
        pcall(function()
            if _G.Settings.Main["Select Weapon"] == "拳法" then
                for i, v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
            ...
            elseif _G.Settings.Main["Select Weapon"] == "剑" then
                for i, v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
            ...
            elseif _G.Settings.Main["Select Weapon"] == "枪" then
                for i, v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
            ...
            elseif _G.Settings.Main["Select Weapon"] == "果实" then
                for i, v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
...
local LevelFarmMethodList = {"接任务", "不接任务", "附近的"};
...
spawn(function()
    while wait(0.2) do
        if _G.Settings.Main["Farm Level Method"] == "不接任务" and _G.Settings.Main["Auto Farm"] then
            pcall(function()
                CheckQuest();
...
spawn(function()
    while wait(0.2) do
        if _G.Settings.Main["Farm Level Method"] == "附近的" and _G.Settings.Main["Auto Farm"] then
            pcall(function()
...
spawn(function()
    while wait(0.2) do
        if _G.Settings.Main["Farm Level Method"] == "接任务" and _G.Settings.Main["Auto Farm"] then
            pcall(function()
                CheckQuest();
...
if World3 then
    MasteryMethodList = {"接任务", "不接任务", "附近的", "蛋糕王子", "骨头"};
elseif World2 or World1 then
    MasteryMethodList = {"接任务", "不接任务", "附近的"};
end
...
spawn(function()
    while task.wait(0.2) do
        if _G.Settings.Main["Auto Farm Sword Mastery"] and _G.Settings.Main["Mastery Method"] == "接任务" then
            pcall(function()
                CheckQuest();
        ...
        elseif _G.Settings.Main["Auto Farm Sword Mastery"] and _G.Settings.Main["Mastery Method"] == "不接任务" then
            pcall(function()
                CheckQuest();
                TweenPlayer(CFrameMon);
                if game.Workspace.Enemies:FindFirstChild(Mon) then
        ...
        elseif _G.Settings.Main["Auto Farm Sword Mastery"] and _G.Settings.Main["Mastery Method"] == "骨头" then
            pcall(function()
        ...
        elseif _G.Settings.Main["Auto Farm Sword Mastery"] and _G.Settings.Main["Mastery Method"] == "蛋糕王子" then
            pcall(function()
        ...
        elseif _G.Settings.Main["Auto Farm Sword Mastery"] and _G.Settings.Main["Mastery Method"] == "附近的" then
            pcall(function()
                for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
...
spawn(function()
    while task.wait(0.2) do
        if _G.Settings.Main["Auto Farm Fruit Mastery"] and _G.Settings.Main["Mastery Method"] == "接任务" then
            pcall(function()
                CheckQuest();
                if not string.find((game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle
                                       .Title.Text, NameMon) or
        ...
        elseif _G.Settings.Main["Auto Farm Fruit Mastery"] and _G.Settings.Main["Mastery Method"] == "不接任务" then
            pcall(function()
                CheckQuest();
                TweenPlayer(CFrameMon);
                if game.Workspace.Enemies:FindFirstChild(Mon) then
        ...
        elseif _G.Settings.Main["Auto Farm Fruit Mastery"] and _G.Settings.Main["Mastery Method"] == "骨头" then
            pcall(function()
                TweenPlayer(QuestBonePos);
                if (game:GetService("Workspace")).Enemies:FindFirstChild("Reborn Skeleton") or
                    (game:GetService("Workspace")).Enemies:FindFirstChild("Living Zombie") or
        ...
        elseif _G.Settings.Main["Auto Farm Fruit Mastery"] and _G.Settings.Main["Mastery Method"] == "蛋糕王子" then
            pcall(function()
                local PosCake = CFrame.new(-2091.911865234375, 70.00884246826172, -12142.8359375);
                TweenPlayer(PosCake);
                if (game:GetService("Workspace")).Enemies:FindFirstChild("Cookie Crafter") or
        ...
        elseif _G.Settings.Main["Auto Farm Fruit Mastery"] and _G.Settings.Main["Mastery Method"] == "附近的" then
            pcall(function()
                for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
                    if v.Name and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position -
...
spawn(function()
    while task.wait(0.2) do
        if _G.Settings.Main["Auto Farm Gun Mastery"] and _G.Settings.Main["Mastery Method"] == "接任务" then
            pcall(function()
                CheckQuest();
                if not string.find((game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle
                                       .Title.Text, NameMon) or
        ...
        elseif _G.Settings.Main["Auto Farm Gun Mastery"] and _G.Settings.Main["Mastery Method"] == "不接任务" then
            pcall(function()
                CheckQuest();
                TweenPlayer(CFrameMon);
                if game.Workspace.Enemies:FindFirstChild(Mon) then
        ...
        elseif _G.Settings.Main["Auto Farm Gun Mastery"] and _G.Settings.Main["Mastery Method"] == "骨头" then
            pcall(function()
                TweenPlayer(QuestBonePos);
                if (game:GetService("Workspace")).Enemies:FindFirstChild("Reborn Skeleton") or
                    (game:GetService("Workspace")).Enemies:FindFirstChild("Living Zombie") or
        ...
        elseif _G.Settings.Main["Auto Farm Gun Mastery"] and _G.Settings.Main["Mastery Method"] == "蛋糕王子" then
            pcall(function()
                local PosCake = CFrame.new(-2091.911865234375, 70.00884246826172, -12142.8359375);
                TweenPlayer(PosCake);
                if (game:GetService("Workspace")).Enemies:FindFirstChild("Cookie Crafter") or
        ...
        elseif _G.Settings.Main["Auto Farm Gun Mastery"] and _G.Settings.Main["Mastery Method"] == "附近的" then
            pcall(function()
                for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
                    if v.Name and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position -
    ...
    while wait(0.2) do
        pcall(function()
            if (game:GetService("ReplicatedStorage")):FindFirstChild(_G.Settings.Main["Selected Boss"]) or
                ...
                BossStatusParagraph:SetDesc("生成了");
            else
                BossStatusParagraph:SetDesc("没生成");
            end
        end);
    end
end);
    ...
    while wait(0.2) do
        pcall(function()
            if (game:GetService("ReplicatedStorage")):FindFirstChild("Diablo") or
                ...
                EliteHunterParagraph:SetDesc("生成了");
            else
                EliteHunterParagraph:SetDesc("没生成");
            end
        end);
    end
end);
    ...
    while wait() do
        pcall(function()
            if World1 or World2 then
                EliteHunterProgressParagraph:SetDesc("只能在三海");
            elseif World3 then
...
local listBoneFarmMethod = {"接任务", "不接任务"};
...
spawn(function()
    while wait(0.2) do
        if _G.Settings.Farm["Selected Bone Farm Method"] == "不接任务" and _G.Settings.Farm["Auto Farm Bone"] and World3 then
            pcall(function()
                if (game:GetService("Workspace")).Enemies:FindFirstChild("Reborn Skeleton") or
                    (game:GetService("Workspace")).Enemies:FindFirstChild("Living Zombie") or
                    (game:GetService("Workspace")).Enemies:FindFirstChild("Demonic Soul") or
...
spawn(function()
    while wait(0.2) do
        if _G.Settings.Farm["Selected Bone Farm Method"] == "接任务" and _G.Settings.Farm["Auto Farm Bone"] and World3 then
            pcall(function()
                local QuestTitle = (game:GetService("Players")).LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle
                                       .Title.Text;
    ...
    while task.wait(5) do
        pcall(function()
            if World3 then
                ...
                CakePrinceStatusParagraph:SetDesc("只能在三海");
            end
        end);
    end
end);
...
spawn(function()
    while wait() do
        if _G.Settings.Setting["Fast Attack Mode"] == "慢" then
            _G.Settings.Setting["Fast Attack Delay"] = 0.32;
        elseif _G.Settings.Setting["Fast Attack Mode"] == "正常" then
            _G.Settings.Setting["Fast Attack Delay"] = 0.22;
        elseif _G.Settings.Setting["Fast Attack Mode"] == "快" then
            _G.Settings.Setting["Fast Attack Delay"] = 0.17;
        elseif _G.Settings.Setting["Fast Attack Mode"] == "超快" then
...
spawn(function()
    while wait() do
        if _G.Settings.Setting["Bring Mob"] then
            pcall(function()
                if _G.Settings.Setting["Bring Mob Mode"] == "小" then
                    BringMobDistance = 150;
                elseif _G.Settings.Setting["Bring Mob Mode"] == "正常" then
                    BringMobDistance = 250;
                elseif _G.Settings.Setting["Bring Mob Mode"] == "大" then
    ...
    pcall(function()
        while wait(0.2) do
            if (game:GetService("Players")).LocalPlayer.PlayerGui.Main.TopHUDList.RaidTimer.Visible == true then
                ...
                TimeRaidParagraph:SetDesc("等待开始");
            end
        end
    end);
end);
...
local PlaceV4List = {"大树顶上", "时间神殿", "拉杆", "古代一号"};
...
spawn(function()
    while wait(0.2) do
        if _G.Settings.Race["Teleport To Place"] then
            pcall(function()
                if _G.Settings.Race["Selected Place"] == "大树顶上" then
                    TweenPlayer(CFrame.new(2947.556884765625, 2281.630615234375, -7213.54931640625));
                elseif _G.Settings.Race["Selected Place"] == "时间神殿" then
                ...
                elseif _G.Settings.Race["Selected Place"] == "拉杆" then
                ...
                elseif _G.Settings.Race["Selected Place"] == "古代一号" then
...
spawn(function()
    pcall(function()
        while wait(0.2) do
            if _G.Settings.SeaEvent["Selected Zone"] == "1" then
                CFrameSelectedZone = CFrame.new(-21998.375, 30.0006084, -682.309143, 0.120013528, 0.00690158736,
                    ...
                    0.120211802);
            elseif _G.Settings.SeaEvent["Selected Zone"] == "2" then
                CFrameSelectedZone = CFrame.new(-26779.5215, 30.0005474, -822.858032, 0.307457417, 0.019647358,
                    ...
                    0.308084518);
            elseif _G.Settings.SeaEvent["Selected Zone"] == "3" then
                CFrameSelectedZone = CFrame.new(-31171.957, 30.0001011, -2256.93774, 0.37637493, 0.0150483791,
                    ...
                    0.376675636);
            elseif _G.Settings.SeaEvent["Selected Zone"] == "4" then
            ...
            elseif _G.Settings.SeaEvent["Selected Zone"] == "5" then
                CFrameSelectedZone = CFrame.new(-38887.5547, 30.0004578, -2162.99023, -0.188895494, -0.00704088295,
                    ...
                    -0.189026669);
            elseif _G.Settings.SeaEvent["Selected Zone"] == "6" then
                CFrameSelectedZone = CFrame.new(-44541.7617, 30.0003204, -1244.8584, -0.0844199061, -0.00553312758,
                    ...
                    -0.0846010372);
            elseif _G.Settings.SeaEvent["Selected Zone"] == "无限" then
    ...
    pcall(function()
        while wait(0.2) do
            if game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
                MirageStatusSeaStackParagraph:SetDesc("✅ 幻影岛生成");
            else
                MirageStatusSeaStackParagraph:SetDesc("❌ 幻影岛未生成");
            end
            if game.Workspace._WorldOrigin.Locations:FindFirstChild("Kitsune Island") then
                KitsuneStatusSeaStackParagraph:SetDesc("✅ 狐狸岛生成");
            else
                KitsuneStatusSeaStackParagraph:SetDesc("❌ 狐狸岛未生成");
            end
            if game.Workspace._WorldOrigin.Locations:FindFirstChild("Frozen Dimension") then
                FrozenStatusSeaStackParagraph:SetDesc("✅ 冰岛生成");
            else
                FrozenStatusSeaStackParagraph:SetDesc("❌ 冰岛未生成");
            end
            if game.Workspace._WorldOrigin.Locations:FindFirstChild("Prehistoric Island") then
                PrehistoricStatusSeaStackParagraph:SetDesc("✅ 火山生成");
            else
                PrehistoricStatusSeaStackParagraph:SetDesc("❌ 火山未生成");
            end
        end
    end);
end);
...
local SelectRarityFruits = {"普通-神话", "常见-神话", "稀有-神话", "传奇-神话",
                            "神话"};
...
function CheckFruits()
    for i, v in pairs(RarityFruits) do
        if _G.Settings.Fruit["Store Rarity Fruit"] == "普通-神话" then
        ...
        elseif _G.Settings.Fruit["Store Rarity Fruit"] == "常见-神话" then
            if i == "Uncommon" or i == "Rare" or i == "Legendary" or i == "Mythical" then
                for _, fruit in ipairs(v) do
                    table.insert(ResultStoreFruits, fruit);
                end
            end
        elseif _G.Settings.Fruit["Store Rarity Fruit"] == "稀有-神话" then
            if i == "Rare" or i == "Legendary" or i == "Mythical" then
                for _, fruit in ipairs(v) do
                    table.insert(ResultStoreFruits, fruit);
                end
            end
        elseif _G.Settings.Fruit["Store Rarity Fruit"] == "传奇-神话" then
            if i == "Legendary" or i == "Mythical" then
                for _, fruit in ipairs(v) do
                    table.insert(ResultStoreFruits, fruit);
                end
            end
        elseif _G.Settings.Fruit["Store Rarity Fruit"] == "神话" then
            if i == "Mythical" then
                for _, fruit in ipairs(v) do
                    table.insert(ResultStoreFruits, fruit);
                end
    ...
    while task.wait() do
        pcall(function()
            if (game:GetService("Lighting")).Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149431" then
                MoonServerParagraph:SetDesc("满月100%");
            elseif (game:GetService("Lighting")).Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149052" then
                MoonServerParagraph:SetDesc("满月75%");
            elseif (game:GetService("Lighting")).Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709143733" then
                MoonServerParagraph:SetDesc("满月50%");
            elseif (game:GetService("Lighting")).Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709150401" then
                MoonServerParagraph:SetDesc("满月25%");
            elseif (game:GetService("Lighting")).Sky.MoonTextureId == "http://www.roblox.com/asset/?id=9709149680" then
                MoonServerParagraph:SetDesc("满月15%");
            else
                MoonServerParagraph:SetDesc("满月0%");
            end
        end);
    end
end);
spawn(function()
    pcall(function()
        while wait(0.2) do
            if World3 then
                if game.Workspace._WorldOrigin.Locations:FindFirstChild("Kitsune Island") then
                    KitsuneStatusParagraph:SetDesc("✅ 狐狸岛生成");
                else
                    KitsuneStatusParagraph:SetDesc("❌ 狐狸岛未生成");
                end
            else
                KitsuneStatusParagraph:SetDesc("仅限三海");
            end
        end
    end);
end);
spawn(function()
    pcall(function()
        while wait(0.2) do
            if World3 then
                if game.Workspace._WorldOrigin.Locations:FindFirstChild("Prehistoric Island") then
                    PrehistoricStatusParagraph:SetDesc("✅ 火山生成");
                else
                    PrehistoricStatusParagraph:SetDesc("❌ 火山未生成");
                end
            else
                PrehistoricStatusParagraph:SetDesc("仅限三海");
            end
        end
    end);
end);
spawn(function()
    pcall(function()
        while wait(0.2) do
            if game.Workspace._WorldOrigin.Locations:FindFirstChild("Frozen Dimension") then
                FrozenStatusParagraph:SetDesc("✅ 冰岛生成");
            else
                FrozenStatusParagraph:SetDesc("❌ 冰岛未生成");
            end
        end
    end);
end);
    ...
    pcall(function()
        while wait(0.2) do
            if World2 or World3 then
                if game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
                    MirageStatusParagraph:SetDesc("✅ 幻影岛生成");
                else
                    MirageStatusParagraph:SetDesc("❌ 幻影岛未生成");
                end
            else
                MirageStatusParagraph:SetDesc("仅限三海");
            end
        end
    end);
end);
        ...
        pcall(function()
            local response =
                (((game:GetService("ReplicatedStorage")):WaitForChild("Remotes")):WaitForChild("CommF_")):InvokeServer(
                    "ColorsDealer", "1");
            if response then
                HakiDealerStatusParagraph:SetDesc("✅ 武装色商人生成");
            else
                HakiDealerStatusParagraph:SetDesc("❌ 武装色商人未生成");
            end
        end);
    end
end);
...
-- 防挂机脚本（VirtualUser自动操作版）
-- 核心逻辑：监听Idled事件，自动模拟鼠标右键操作，避免被判定为挂机
...
if not localPlayer then
    warn("无法获取本地玩家！脚本将停止运行")
    return
end

-- 配置项（可根据需要调整）
local CLICK_DELAY = 1 -- 模拟按键按下和抬起的间隔（秒）
local SAFETY_OFFSET = Vector2.new(1, 1) -- 轻微偏移坐标，避免绝对0点可能的检测
...
local function simulateActivity()
    ...
    if not currentCamera then
        warn("当前无相机对象，跳过本次模拟操作")
        return
    end

    -- 模拟鼠标右键按下
    VirtualUser:Button2Down(SAFETY_OFFSET, currentCamera.CFrame)
    -- 等待指定间隔
    task.wait(CLICK_DELAY)
    -- 模拟鼠标右键抬起
    VirtualUser:Button2Up(SAFETY_OFFSET, currentCamera.CFrame)
    
    -- 可选：输出日志，确认脚本在运行
    print("[防挂机脚本] 已触发自动操作，避免挂机判定")
end

-- 绑定Idled事件：当玩家闲置约15秒时触发
local idleConnection = localPlayer.Idled:Connect(function()
    -- 用pcall包裹，防止操作失败导致脚本崩溃
    local success, err = pcall(simulateActivity)
    if not success then
        warn("[防挂机脚本] 模拟操作失败：", err)
    end
end)

-- 额外防护：脚本销毁时断开连接，避免内存泄漏
local function cleanup()
    if idleConnection then
        idleConnection:Disconnect()
        print("[防挂机脚本] 已断开Idled事件连接")
    end
end
