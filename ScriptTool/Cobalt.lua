...
return {}
    ...
    [23] = function()local wax,script,require=ImportGlobals(23)local ImportGlobals return (function(...)-- Logger
-- ActualMasterOogway
-- December 8, 2024
...
return Animations
    ...
    [29] = function()local wax,script,require=ImportGlobals(29)local ImportGlobals return (function(...)-- LuaEncode - Fast Table Serialization Library for Pure Luau/Lua 5.1+
